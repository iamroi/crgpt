...
program
    ...
    var sourceBranch, targetBranch, file, prId, configPath, config, _a, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 10, , 11]);
                sourceBranch = options.source, targetBranch = options.target, file = options.file, prId = options.prId, configPath = options.config;
                return [4 /*yield*/, (0, config_1.readConfig)(configPath)];
            case 1:
                config = _b.sent();
                _a = action;
                switch (_a) {
                    case 'init': return [3 /*break*/, 2];
                    case 'review': return [3 /*break*/, 4];
                    case 'diff': return [3 /*break*/, 6];
                    case 'desc': return [3 /*break*/, 7];
                }
                return [3 /*break*/, 8];
            case 2: return [4 /*yield*/, (0, init_1.initCRGPT)(configPath, options)];
            case 3:
                _b.sent();
                _b.label = 4;
            case 4:
                ...
                return [4 /*yield*/, (0, lib_1.runCRGPT)({ sourceBranch: sourceBranch, targetBranch: targetBranch, file: file, prId: prId }, config)];
            case 5:
                _b.sent();
                _b.label = 6;
